...
Train-test split 
Model evaluation - R squared error  
...
Item_Identifier - code for the identification of items
Item_Weight - weight of item 
Item_Fat_Content - low fat or regular 
Item_Visibility - percentage of item visibility 
Item_Type - category 
Item_MRP - price amount of item 
Outlet_Identifier - code for the identification of outlet store 
